...
func (m *MockInterface) BeginAbortLatestOperation(arg0 context.Context, arg1, arg2, arg3 string, arg4 *armcontainerservice.AgentPoolsClientBeginAbortLatestOperationOptions) (*runtime.Poller[armcontainerservice.AgentPoolsClientAbortLatestOperationResponse], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BeginAbortLatestOperation", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(*runtime.Poller[armcontainerservice.AgentPoolsClientAbortLatestOperationResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
